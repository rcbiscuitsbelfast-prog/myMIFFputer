...
const mockContent: MiffContentPayload = {
  intro: {
  ...
  modules: [
    {
      ...
      content:
        'MIFF Studio keeps your casting boards, shot plans, and AI treatments on one collaborative surface. Bring prompts, palette references, and location notes together.',
      tags: ['story', 'concept'],
      window: {
        width: 520,
        height: 420,
    ...
    },
    {
      ...
      content:
        'Audition MIFF-curated stems, dial intent sliders, and export ready-to-share cues directly into your edit. Pair with timeline markers to stay in sync.',
      tags: ['audio', 'mood'],
      window: {
        width: 480,
        height: 360,
    ...
    },
    {
      ...
      content:
        'Pin photos, capture approvals, and let MIFF highlight the most production-ready routes. Live sync ensures your crew stays aligned when the sun shifts.',
      window: {
        width: 460,
        height: 380,
      },
